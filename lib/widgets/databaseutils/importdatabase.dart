  ...
  static Future<bool?> show(BuildContext context) async {
    final proceed = await showDialog<bool>(
      ...
      builder: (ctx) => ContentDialog(
        title: const Text('Import new database?'),
        content: Text('Are you sure you want to import a new database? This is unrecoverable.'),
        actions: [
          Button(
        ...
        return StatefulBuilder(
          builder: (context, setState) => ContentDialog(
            ...
            content: Column(
              ...
              children: [
                const Text('This action is unrecoverable. The old database will be deleted. To confirm, type:'),
